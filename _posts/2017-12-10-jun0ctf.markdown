...
![img](/img/in-post/post-blog-j0serv2.png)

其中upload.php很大，有1.9M，以二进制打开，发现文件里有flag1.png，同时有一个zip文件头504B 0304。

![img](/img/in-post/post-blog-j0serv4.png)

将不重要的部分删掉，得到文件更改后缀名为zip解压，得到一张图片（还挺好看的 (●ﾟωﾟ●)。

![img](/img/in-post/post-blog-j0serv5.png)

一般套路都是图片里隐写信息，将图片二进制打开，直接去文件尾，得到flag。

![img](/img/in-post/post-blog-j0serv6.png)
...
![img](/img/in-post/post-blog-j0serv3.png)
...
![img](/img/in-post/post-blog-j0serv0.png)
