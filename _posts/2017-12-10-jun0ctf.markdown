...
date:       2017-12-10
author:     "Miyunluo"
header-img: "img/post-bg-SJTU0CTF.png"
tags:
    - CTF
---
...
![img](/img/in-post/post-blog-jserv12.png)

使用IDA打开encoder进行分析。```main```函数如下，主要调用了```sub_4006D6()```这个函数

![img](/img/in-post/post-blog-jserv13.png)

函数```sub_4006D6()```内容如下，是主要的加密过程

![img](/img/in-post/post-blog-jserv14.png)
...
![img](/img/in-post/post-blog-jserv15.png)
...
![img](/img/in-post/post-blog-jserv16.png)

可以看到Sell Gotten与三个问题。执行nc指令

![img](/img/in-post/post-blog-jserv17.png)
...
![img](/img/in-post/post-blog-jserv18.png)

还有一个没有用到的函数getshell()

![img](/img/in-post/post-blog-jserv19.png)

只需要程序的返回地址为getshell()的地址，就会触发执行了。查询得到getshell的起始地址为0804 85cb

![img](/img/in-post/post-blog-jserv20.png)
...
运行代码
![img](/img/in-post/post-blog-jserv21.png)

cd 进入 /home/.../stack 目录，cat 显示flag。
![img](/img/in-post/post-blog-jserv22.png)
